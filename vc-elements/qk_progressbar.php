...
$wrap_class[] = $el_class;
$wrap_class = rose_get_style_color( $wrap_class, $color, 'm-pgs-bar-color', 'background-color:');

$percent_class[] = 'm-pgs-bar'. $type .'-percent';
$percent_class = rose_get_style_color( $percent_class, $color_percent, 'm-pgs-bar-color', 'background-color:');

$title_class[] = 'm-pgs-bar'. $type .'-title';
$title_class = rose_get_style_color( $title_class, $color_title, 'm-pgs-bar-color', 'color:');
?>
