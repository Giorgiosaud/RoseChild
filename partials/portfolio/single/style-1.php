    ...
    <div class="portfolio-project-container container">
        ...
        <div class="post-nav-ctrl col-md-12">
            ...
            <?php
                ...
                $previous = get_next_post_link('<span class="arrw-next">%link</span>',     wp_kses( '<i class="icon-arrow-right4">',array( 'span' => array( 'class' => array() ), 'i' => array( 'class' => array() ))));

                // get_previous_post_link( '<span class="arrw-prev">%link</span>', wp_kses( '<i class="icon-arrow-left4"></i>' ),array( 'span' => array( 'class' => array() ), 'i' => array( 'class' => array() )));
